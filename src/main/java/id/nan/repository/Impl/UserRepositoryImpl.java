...
/**
 * Implementation of UserRepository interface for managing User entities in the database
 * Implementasi dari interface UserRepository untuk mengelola entitas User dalam database
 */
